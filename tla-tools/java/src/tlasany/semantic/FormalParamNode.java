...
public class FormalParamNode extends SymbolNode {
  ...
  private int          arity;      // arity of the parameter; 0 for ordinary param; >0 for operator param
  private ModuleNode   moduleNode; // the module in which this formal param was declared
