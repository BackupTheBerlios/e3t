...
// Last modified on Fri Aug 10 15:10:04 PDT 2001 by yuanyu
...
public class SetPredValue extends Value implements Enumerable {
  public Object vars;           // OpDeclNode or OpDeclNode[]
  ...
  public final boolean member(Value elem) {
	...
	if (this.vars instanceof OpDeclNode) {
	  con1 = con1.cons((OpDeclNode)this.vars, elem);
	}
	else {
	  OpDeclNode[] ids = (OpDeclNode[])this.vars;
  ...
  public final StringBuffer toString(StringBuffer sb, int offset) {
    ...
    sb.append("{");
    if (this.vars instanceof OpDeclNode) {
      sb.append(((OpDeclNode)this.vars).getName());
    }
    else {
      OpDeclNode[] ids = (OpDeclNode[])this.vars;
  ...
  final class Enumerator implements ValueEnumeration {
	...
	if (vars instanceof OpDeclNode) {
	  ...
	  OpDeclNode[] ids = (OpDeclNode[])vars;
	  TupleValue tv = TupleValue.convert(elem);
	  if ((tv != null) &&
