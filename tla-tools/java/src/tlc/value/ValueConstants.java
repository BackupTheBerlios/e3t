...
// Last modified on Tue Aug 15 16:45:14 PDT 2000 by yuanyu
...
public interface ValueConstants {
  ...
  public final Value EmptySet = new SetEnumValue(new ValueVec(), true);
  ...
  public final RecordValue EmptyRcd =
    new RecordValue(new UniqueString[0], new Value[0], true);
