...
// Last modified on Wed Dec  5 23:18:07 PST 2001 by yuanyu
...
public abstract class Value implements ValueConstants, Serializable {
  ...
  public long fingerPrint(long fp) {
    Assert.fail("TLC has found a state in which a variable is assigned to " +
