...
// Last modified on Thu Feb  8 21:23:55 PST 2001 by yuanyu
...
public class LazyValue extends Value {
   ...
   * computed, but when computed, the value can be cached in val. If
   * val is ValUndef, then the value has not been computed, and when
   * computed, it can not be cached in val.
   */
