...
// Last modified on Thu Jan 10 18:33:42 PST 2002 by yuanyu
...
public final class DiskIntStack {
  ...
  class Reader extends Thread {
	...
	RuntimeConfiguration.get().getErrStream().println("Error: when reading the disk (DiskIntStack.Reader.run):\n" +
			   e.getMessage());
	// System.exit(1);
      }
    }
  ...
  class Writer extends Thread {
	...
	RuntimeConfiguration.get().getErrStream().println("Error: when reading the disk (DiskIntStack.Writer.run):\n" +
			   e.getMessage());
	// System.exit(1);
      }
    }
